package DebounceFunction;

/*
 * Debouncing in JavaScript is a practice used to improve browser performance.
 * There might be some functionality in a web page which 
 * requires time-consuming computations. 
 * 
 * If such a method is invoked frequently, it might greatly affect the performance 
 * of the browser, as JavaScript is a single threaded language. 
 * 
